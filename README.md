...
The React frontend lives in `frontend/`. See `frontend/README.md` for setup. The API base URL is configured via `VITE_API_BASE_URL` (see `.env.example`). To seed the demo suite, run `python -m src.handlers.api.seed`.
